<template>
  <div v-if="assessment" class="bg-white rounded-xl shadow-sm overflow-hidden">
    ...
    <button type="button" @click="expanded = !expanded" class="w-full text-left px-5 pt-5 pb-4 cursor-pointer">
      <div class="flex items-center justify-between mb-3">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 text-gray-400 transition-transform duration-300 flex-shrink-0"
